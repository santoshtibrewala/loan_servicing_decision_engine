const sampleCase = {
  case: {
    ...
    state: 'IA',
    county: 'Polk',
    financiallyDistressed: false,
    daysPastDue: 112,
    noticeOfDelinquencyDate: '2026-01-15',
    ...
    distressCause: 'low_commodity_prices',
    referredToCounsel: false,
    cropInsuranceViolation: false,
    nonMonetaryDefault: false,
    nonEssentialAssetsAvailable: false,
    nonEssentialAssetLiquidationValue: 0,
    buyoutFundsAvailable: 0,
...
const casePresets = [
  ...
  },
  {
    ...
    data: {
      case: {
        ...
        financiallyDistressed: false,
        daysPastDue: 128,
        noticeOfDelinquencyDate: '2026-01-20',
        ...
        applicationComplete: true,
        temporaryHardship: false,
        distressCause: 'adverse_weather',
        referredToCounsel: false,
        cropInsuranceViolation: false,
        nonMonetaryDefault: false,
        nonEssentialAssetsAvailable: true,
        nonEssentialAssetLiquidationValue: 15000,
        buyoutFundsAvailable: 0,
        deferralYearsRequested: 0,
        previousDebtForgivenessFlag: false,
        previousDebtForgivenessAmount: 0,
  ...
  {
    id: 'case3',
    label: 'Multi-Loan Multi-Collateral',
    description:
    ...
    data: {
      case: {
        ...
        financiallyDistressed: false,
        daysPastDue: 98,
        noticeOfDelinquencyDate: '2025-12-20',
  ...
  {
    id: 'case4',
    label: 'Kansas Delinquent Loan Consolidation',
    description:
      'Two delinquent operating loans where consolidation creates the first feasible servicing path.',
    data: {
      case: {
        borrowerId: 'KS-CASE-4',
        borrowerType: 'entity',
        state: 'KS',
        county: 'Sedgwick',
        financiallyDistressed: false,
        daysPastDue: 121,
        noticeOfDelinquencyDate: '2026-01-10',
        proposedServicingDate: '2026-03-20',
        completedApplicationDate: '2026-02-25',
        approvedFarmBusinessPlanDate: '2026-02-20',
        firstPaymentDueDate: '2027-01-01',
        debtMarginPercent: 0,
        goodFaith: true,
        applicationComplete: true,
      ...
      cashFlow: {
        firstYear: {
          operatingExpense: 180000,
          operatingInterestExpense: 18000,
          ownerWithdrawals: 22000,
          balanceAvailable: 73200,
          nonAgencyDebtAndTaxes: 18000,
        },
      },
      existingLoans: [
        {
          ...
          accrualDate: '2026-03-20',
          existingRate: 0.0475,
          originalRate: 0.0525,
          originalNoteDate: '2021-04-01',
          maturityDate: '2030-04-01',
          remainingTermYears: 4,
          maxTermYears: 10,
          paymentSchedule: 'EQ',
          firstYearPayment: 70000,
          servicingAction: 'Y',
          delinquentAmountDue: 18000,
          limitedResource: false,
          limitedResourceEligible: false,
          consolidationAllowed: true,
          paidInFull: false,
          securityType: 'chattel',
        },
        {
          loanId: 'OL-502',
          fundCode: 'OL',
          loanType: 'operating',
          principal: 180000,
          accruedInterest: 6000,
          accrualDate: '2026-03-20',
          existingRate: 0.05,
          originalRate: 0.055,
          originalNoteDate: '2022-06-15',
          maturityDate: '2031-06-15',
          remainingTermYears: 5,
          maxTermYears: 10,
          paymentSchedule: 'EQ',
          firstYearPayment: 49000,
          servicingAction: 'Y',
          delinquentAmountDue: 14000,
          limitedResource: false,
          limitedResourceEligible: false,
          consolidationAllowed: true,
          paidInFull: false,
      ...
      collateral: [
        {
          propertyId: 'KS-CH-1',
          propertyType: 'CHL',
          description: 'Harvest equipment',
          marketValue: 410000,
          recoverableValue: 300000,
          totalAcres: 0,
          propertyTaxes: 0,
          managedAcres: 0,
          ratePerAcre: 0,
          managementIncome: 0,
          monthlyManagementCost: 120,
          managementContractShare: 0,
          repairCost: 7000,
          repairDescription: 'Equipment prep',
          otherExpenseCost: 4000,
          otherExpenseDescription: 'Broker costs',
          monthlyIncome: 0,
          incomeDescription: '',
          linkedLoanIds: ['OL-501', 'OL-502'],
        },
        {
          propertyId: 'KS-CH-2',
          propertyType: 'CHL',
          description: 'Livestock and vehicles',
          marketValue: 220000,
          recoverableValue: 150000,
          totalAcres: 0,
          propertyTaxes: 0,
          managedAcres: 0,
          ratePerAcre: 0,
          managementIncome: 0,
          monthlyManagementCost: 90,
          managementContractShare: 0,
          repairCost: 3000,
          repairDescription: 'Transport and staging',
          otherExpenseCost: 2500,
          otherExpenseDescription: 'Sale costs',
          monthlyIncome: 0,
          incomeDescription: '',
          linkedLoanIds: ['OL-501', 'OL-502'],
        },
  ...
  {
    id: 'case5',
    label: 'Texas Multi-Loan Consolidation Relief',
    description:
      'Three delinquent borrower loans where consolidation improves servicing capacity across operating and emergency debt.',
    data: {
      case: {
        borrowerId: 'TX-CASE-5',
        borrowerType: 'partnership',
        state: 'TX',
        county: 'Travis',
        financiallyDistressed: true,
        daysPastDue: 95,
        noticeOfDelinquencyDate: '2026-01-12',
        proposedServicingDate: '2026-03-25',
        completedApplicationDate: '2026-02-18',
        approvedFarmBusinessPlanDate: '2026-02-12',
        firstPaymentDueDate: '2027-01-01',
        debtMarginPercent: 0,
        goodFaith: true,
        applicationComplete: true,
      ...
      cashFlow: {
        firstYear: {
          ...
          operatingInterestExpense: 24000,
          ownerWithdrawals: 20000,
          balanceAvailable: 121000,
          nonAgencyDebtAndTaxes: 30000,
        },
      },
      existingLoans: [
        {
          ...
          accrualDate: '2026-03-25',
          existingRate: 0.052,
          originalRate: 0.056,
          originalNoteDate: '2021-03-01',
          maturityDate: '2030-03-01',
          remainingTermYears: 4,
          maxTermYears: 10,
          paymentSchedule: 'EQ',
          firstYearPayment: 62000,
          servicingAction: 'Y',
          delinquentAmountDue: 15000,
          limitedResource: false,
          limitedResourceEligible: false,
          consolidationAllowed: true,
          paidInFull: false,
        ...
        },
        {
          ...
          existingRate: 0.051,
          originalRate: 0.054,
          originalNoteDate: '2022-05-01',
          maturityDate: '2031-05-01',
          remainingTermYears: 5,
          maxTermYears: 10,
          paymentSchedule: 'EQ',
          firstYearPayment: 39000,
          servicingAction: 'Y',
          delinquentAmountDue: 12000,
          limitedResource: false,
          limitedResourceEligible: false,
        ...
        },
        {
          ...
          existingRate: 0.045,
          originalRate: 0.0475,
          originalNoteDate: '2023-02-10',
          maturityDate: '2031-02-10',
          remainingTermYears: 5,
          maxTermYears: 12,
          paymentSchedule: 'EQ',
          firstYearPayment: 28000,
          servicingAction: 'Y',
          delinquentAmountDue: 9000,
          limitedResource: false,
          limitedResourceEligible: false,
          consolidationAllowed: true,
          paidInFull: false,
      ...
      collateral: [
        {
          propertyId: 'TX-CH-61',
          propertyType: 'CHL',
          description: 'Cotton equipment line',
          marketValue: 350000,
          recoverableValue: 260000,
          totalAcres: 0,
          propertyTaxes: 0,
          managedAcres: 0,
          ratePerAcre: 0,
          managementIncome: 0,
          monthlyManagementCost: 140,
          managementContractShare: 0,
          repairCost: 8000,
          repairDescription: 'Equipment preparation',
          otherExpenseCost: 5000,
          otherExpenseDescription: 'Sale fees',
          monthlyIncome: 0,
          incomeDescription: '',
          linkedLoanIds: ['OL-611', 'OL-612', 'EM-613'],
        },
        {
          propertyId: 'TX-CH-62',
          propertyType: 'CHL',
          ...
          ratePerAcre: 0,
          managementIncome: 0,
          monthlyManagementCost: 110,
          managementContractShare: 0,
          repairCost: 3500,
          repairDescription: 'Transport and care',
          otherExpenseCost: 2600,
          otherExpenseDescription: 'Auction fees',
          monthlyIncome: 0,
          incomeDescription: '',
          linkedLoanIds: ['OL-611', 'OL-612'],
        },
      ],
      liens: {
        propertyLoanLinks: [
...
const config = {
  ...
  policy: {
    ...
    servicingRules: {
      delinquencyDaysThreshold: 90,
      applicationWindowDays: 60,
      maxDeferralYears: 5,
      requireTemporaryHardshipForDeferral: true,
      requireLimitedResourceEligibilityForRateReduction: true,
      requireRegularRateFailureBeforeLimitedResource: true,
      requireGoodFaith: true,
      requireApplicationComplete: true,
      requireDistressOrDelinquency: true,
      requireBeyondControlDistressCause: true,
      blockForCropInsuranceViolation: true,
      requireNonMonetaryDefaultResolution: true,
      requireNonEssentialAssetReviewBeforeWritedown: true,
      requireBuyoutFundsForCmv: true,
      reschedulingEligibleLoanTypes: ['operating', 'emergency'],
      reamortizationEligibleLoanTypes: ['farm_ownership'],
      consolidationSecurityTypeExclusions: ['real_estate'],
      requireSameLienPositionForConsolidation: true,
      disallowConsolidationWhenDeferred: true,
      disallowConsolidationWhenReferredToCounsel: true,
    },
