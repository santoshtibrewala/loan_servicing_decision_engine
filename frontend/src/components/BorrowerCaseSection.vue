  ...
  >
    <div class="grid gap-[14px] xl:grid-cols-4">
      ...
      <label class="grid gap-1.5 font-semibold text-[#293c4f]">
        Borrower type
        <select
          v-model="model.case.borrowerType"
          class="w-full rounded-[10px] border-2 border-[#0e416a] bg-white px-[14px] py-3 text-[#17334d]"
        >
          <option
      ...
      <label class="grid gap-1.5 font-semibold text-[#293c4f]">
        Days past due
        <input
          v-model.number="model.case.daysPastDue"
          type="number"
          min="0"
          class="w-full rounded-[10px] border-2 border-[#0e416a] bg-white px-[14px] py-3 text-[#17334d]"
        />
      ...
      <label class="grid gap-1.5 font-semibold text-[#293c4f]">
        ...
        <input
          v-model="model.case.noticeOfDelinquencyDate"
          type="date"
          class="w-full rounded-[10px] border-2 border-[#0e416a] bg-white px-[14px] py-3 text-[#17334d]"
        />
      </label>
      <label class="grid gap-1.5 font-semibold text-[#293c4f]">
        Distress cause
        <select
          v-model="model.case.distressCause"
          class="w-full rounded-[10px] border-2 border-[#0e416a] bg-white px-[14px] py-3 text-[#17334d]"
        >
    ...
    <div class="mt-4 grid gap-[14px] md:grid-cols-2 xl:grid-cols-3">
      <label
        class="flex items-center gap-3 rounded-[12px] border border-[#d4dee7] bg-[#eef4f9] px-4 py-3 font-semibold text-[#293c4f]"
      >
        <input
          v-model="model.case.goodFaith"
          type="checkbox"
          class="h-4 w-4 rounded border-[#0e416a]"
        />
        Good faith
      </label>
      <label
      ...
      >
        <input
          v-model="model.case.applicationComplete"
          type="checkbox"
          class="h-4 w-4 rounded border-[#0e416a]"
        />
      ...
      >
        <input
          v-model="model.case.financiallyDistressed"
          type="checkbox"
          class="h-4 w-4 rounded border-[#0e416a]"
        />
      ...
      >
        <input
          v-model="model.case.temporaryHardship"
          type="checkbox"
          class="h-4 w-4 rounded border-[#0e416a]"
        />
        Temporary hardship
      ...
      >
        <input
          v-model="model.case.nonEssentialAssetsAvailable"
          type="checkbox"
          class="h-4 w-4 rounded border-[#0e416a]"
        />
      ...
      >
        <input
          v-model="model.case.referredToCounsel"
          type="checkbox"
          class="h-4 w-4 rounded border-[#0e416a]"
        />
        Referred to counsel
      ...
      >
        <input
          v-model="model.case.cropInsuranceViolation"
          type="checkbox"
          class="h-4 w-4 rounded border-[#0e416a]"
        />
      ...
      >
        <input
          v-model="model.case.nonMonetaryDefault"
          type="checkbox"
          class="h-4 w-4 rounded border-[#0e416a]"
        />
