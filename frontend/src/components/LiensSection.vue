        ...
        <div class="grid gap-[14px]">
          ...
          >
            ...
            >
              ...
              <button
                class="rounded-[12px] border border-[#adc1d4] bg-white px-[14px] py-[9px] font-semibold text-[#b53d2f]"
                @click="emit('remove-prior-lien', index)"
              >
                Remove
              </button>
            </div>
            <div class="grid gap-[14px] md:grid-cols-2">
              <label class="grid gap-1.5 font-semibold text-[#293c4f]"
                >Property ID<input
                  v-model="lien.propertyId"
                  class="w-full rounded-[10px] border-2 border-[#0e416a] bg-white px-[14px] py-3 text-[#17334d]"
              /></label>
              <label class="grid gap-1.5 font-semibold text-[#293c4f]"
                >Creditor<input
                  v-model="lien.creditorName"
                  class="w-full rounded-[10px] border-2 border-[#0e416a] bg-white px-[14px] py-3 text-[#17334d]"
              /></label>
              <label class="grid gap-1.5 font-semibold text-[#293c4f]"
                >Prior debt<FormattedNumberInput
                  v-model="lien.totalDebtPriorToFsaLien"
                  kind="amount"
                  :min="0"
                  class="w-full rounded-[10px] border-2 border-[#0e416a] bg-white px-[14px] py-3 text-[#17334d]"
              /></label>
